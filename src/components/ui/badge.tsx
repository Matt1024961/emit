  ...
  "inline-flex items-center justify-center rounded-md border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none transition-[color,box-shadow] overflow-hidden",
  {
    variants: {
      variant: {
        ...
        primary: "border-transparent bg-primary-muted text-primary-muted-foreground",
...
/** shadcn/ui Badge with added domain variants (success, warning, info, primary, muted). */
function Badge({
  className,
  variant,
  asChild = false,
